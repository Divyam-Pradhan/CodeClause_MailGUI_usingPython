...
class MailApp:
    def __init__(self, master):
        ...
        tkinter.Tk.config(master, background="lightblue")

       
        self.from_label = tk.Label(master, text="SENDER:       ", background="grey")
        ...
        self.pass_label = tk.Label(master, text="APP PSWD:       ", background="grey")
        ...
        self.to_label = tk.Label(master, text="RECIPIENT:        ", background="grey")
        ...
        self.subject_label = tk.Label(master, text="SUB:     ", background="grey")
        ...
        self.body_label = tk.Label(master, text="EMAIL CONTENT (BODY):     ", background="grey")
        ...
        self.send_button = tk.Button(master, text="SEND", command=self.send_mail, width=16,
                                     background="lightblue", foreground="white", font=8)
